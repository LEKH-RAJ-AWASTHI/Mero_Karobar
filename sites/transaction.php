...
$purchase_bill_array=$transactions[0];
$sales_bill_array=$transactions[1];
$receipt_bill_array=$transactions[2];
$voucher_bill_array=$transactions[3];
...
<div id="purchase-bill" class="container mt-5">
  ...
  <h2 class="float-start">Purchase Transactions</h2>
    ...
    <table class="table table-bordered table-primary">
      ...
      <tbody>
        <?php
          if(($purchase_bill_array['empty']==['empty'])){
            echo "<tr>";
  ...
  <h2 class="float-start">Sales Transactions</h2>
    <div class="float-end me-5 pe-4">
      ...
      <div><a style="width: 80%" href="#receipt-bill ">Receipt Transactions</a></div>
      <div><a style="width: 80%" href="#voucher-bill ">Voucher Transactions</a></div>
    </div>    <table class="table table-bordered table-active">
      <thead>
        <tr>
          <th>Date</th>
          <th>Client</th>
      ...
      <tbody>
        <?php
          if(($sales_bill_array['empty']==['empty'])){
            echo "<tr>";
            echo '<td colspan="5" style="color: red;" >No data found</td>';
            echo "</tr>";
          }
  ...
  <h2 class="float-start">Receipt Transactions</h2>
    <div class="float-end me-5 pe-4">
      ...
      <div><a style="width: 80%" href="#sales-bill ">Sales Transactions</a></div>
      <div><a style="width: 80%" href="#voucher-bill ">Voucher Transactions</a></div>
    </div>    <table class="table table-bordered table-info">
      <thead>
        <tr>
          <th>Date</th>
          <th>Client</th>
      ...
      <tbody>
        <?php
            if(($receipt_bill_array['empty']==['empty'])){
              echo "<tr>";
              echo '<td colspan="5" style="color: red;" >No data found</td>';
              echo "</tr>";
            }
  ...
  <h2 class="float-start">Voucher Transactions</h2>
    <div class="float-end me-5 pe-4 ">
      ...
      <div><a style="width: 80%" href="#sales-bill ">Sales Transactions</a></div>
      <div><a style="width: 80%" href="#receipt-bill">Receipt Transactions</a></div>
    </div>    <table class="table table-bordered table-secondary">
      <thead>
        <tr>
          <th>Date</th>
          <th>Client</th>
      ...
      <tbody>
        <?php
            if(($voucher_bill_array['empty']==['empty'])){
              echo "<tr>";
              echo '<td colspan="5" style="color: red;" >No data found</td>';
              echo "</tr>";
            }
