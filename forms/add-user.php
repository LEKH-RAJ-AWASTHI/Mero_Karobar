...
if (isset($_POST['submit'])) {
  ...
  $privilege = get_safe_value($con, $_POST['privilege']);
  ...
  if ($res) {
    ...
    if ($count_rows) {
      ...
      $sql = "INSERT INTO users (user_name, password, privilege) VALUES('$username', '$password', '$privilege')";
...
<div class="container mb-5" id="bill_form">
  <form action="" method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="username" id="username" pattern="[a-zA-Z0-9]+"
        placeholder="Enter username eg: abc123" required>
    </div>
