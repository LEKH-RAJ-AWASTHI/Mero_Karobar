  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Profile Demo</h4>
      ...
      ?>
          ...
          <div class="firm-name"><?php echo $client_firm_name;?></div>
          <div class="client-details">
            <p><strong>Address:</strong> 123 Main Street, City</p>
            <p><strong>PAN Number:</strong> <?php echo $client_pan_number;?></p>
            <p><strong>Contact:</strong> <?php echo $client_phone_number;?></p>
